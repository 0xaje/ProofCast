...
import { shouldAnimateComparisonBar } from "./comparisonMotion";

describe("shouldAnimateComparisonBar", () => {
  ...
  it("animates a changed value from a newer verified source snapshot", () => {
    expect(shouldAnimateComparisonBar(
      { kind: "source", sourceAsOf: 100, value: 45 },
  ...
  it("animates a local forecast only after its deliberate revision changes", () => {
    expect(shouldAnimateComparisonBar(
