...
function Router() { return <Switch><Route path="/" component={Landing} /><Route path="/signal" component={Home} /><Route path="/market" component={MarketDecision} /><Route path="/proof" component={ProofProfile} /><Route path="/admin/review" component={AdminReviewQueue} /><Route path="/404" component={NotFound} /><Route component={NotFound} /></Switch>; }
