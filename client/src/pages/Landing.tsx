...
export default function Landing() {
  return <div className="proof-landing">
    <nav className="pl-nav"><Link href="/" className="pl-wordmark"><span className="pl-seal">↗</span><span>proof<span>cast</span></span></Link><div className="pl-nav-links"><a href="#method">Method</a><a href="#signal">Live signal</a><Link href="/proof">Proof ledger</Link></div><Link href="/signal" className="pl-nav-cta">Enter Signal Room <ArrowUpRight size={15} /></Link></nav>
